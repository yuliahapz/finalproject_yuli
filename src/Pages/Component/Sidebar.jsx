...
const Sidebar = () => {
  ...
  return (
    <Layout.Sider className={`ant-layout-sider xs:w-48 sm:w-64 md:w-80 lg:w-120 xl:w-160`} style={siderStyle}>
      <div>
      ...
      <div className="p-7">
        ...
        <button type="primary" onClick={showModal} className="text-white px-2 rounded">
          Logout
        </button>
