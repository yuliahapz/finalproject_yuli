...
const SearchUser = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try {
            // Assuming the API supports searching users by username
            const response = await axios.get(`https://photo-sharing-api-bootcamp.do.dibimbing.id/api/v1/user?username=${username}`, {
                headers: {
            ...
            setUser(response.data.data.user); // Assuming the user object is in response.data.data.user
            setIsModalOpen(true);
